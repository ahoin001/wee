...
## Corpus Check
- 470 files · ~313,997 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2619 nodes · 6009 edges · 201 communities (146 shown, 55 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 85 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1819d89c`
...
Cohesion: 0.06
Nodes (69): PresetsCommunityCard, PresetsSaveCurrentCard, PresetsSavedListCard, PresetsSpotifyMatchSection, PRESET_UPDATE_SCOPE_OPTIONS, WorkspaceSwitcherModal(), captureSpaceAppearanceFromState(), mergeLiveStateFromSpaceAppearance() (+61 more)
...
Cohesion: 0.07
Nodes (26): UnifiedAppPathCard, UnifiedAppPathSearch(), WeeChannelModal(), PrimaryActionsModal, ChannelsLayoutSettingsTab, IDLE_TYPE_ITEMS, KEN_BURNS_EASING_OPTIONS, KEN_BURNS_MODE_OPTIONS (+18 more)
...
Cohesion: 0.13
Nodes (19): computeSpaceRailContentHeight(), getNextSpace(), maxSpaceRailViewportHeight(), SPACE_META, SPACE_RAIL_LAYOUT, WeeGooeySpacePill(), createWeeShellRailContainerVariants(), createWeeShellRailItemVariants() (+11 more)
...
### Community 9 - "App.jsx"
Cohesion: 0.07
Nodes (30): App(), LazyAdminPanelWidget, LazyClassicWiiDock, LazyCommandPalette, LazyFloatingSpotifyWidget, LazyGameHubSpace, LazyHomePageIndicator, LazyMediaHubSpace (+22 more)

### Community 10 - "SettingsModal.jsx"
Cohesion: 0.08
Nodes (17): DevReactProfiler(), ColorsSettingsTab, GameHubSettingsTab, GeneralSettingsTab, MonitorSettingsTab, MotionFeedbackSettingsTab, NavigationPillSettingsTab, NavigationSettingsTab() (+9 more)
...
Cohesion: 0.27
Nodes (17): NowPlayingSlot(), EMPTY_NOW_PLAYING, enrichSystemWithPremiumSpotifyControls(), hasTrack(), isSpotifySystemApp(), normalizeNowPlaying(), normalizeNowPlayingSourcePreference(), NOW_PLAYING_SOURCE_PREFERENCES (+9 more)
...
Cohesion: 0.19
Nodes (11): SpotifyGradientOverlay(), SpotifyImmersiveOverlay(), WallpaperOverlay(), SystemInfoWidget(), WALLPAPER_OVERLAY_COLORS, useAnimationActivity(), toStoredSession(), useNowPlayingSources() (+3 more)
...
Cohesion: 0.40
Nodes (7): AdminPanelWidget(), defaultUncontrolledSize(), useFloatingWidgetFrame(), viewportResizeBounds(), clampFloatingWidgetPosition(), getViewportSize(), useFloatingWidgetsState()

### Community 29 - "useWeeMotion"
Cohesion: 0.12
Nodes (23): HomePageIndicator(), BoardLivePreview(), LayoutStepper(), createWeeSideNavPeekVariants(), createWeeSideNavShellMotion(), createWeeTransition(), getWeeStatusPillEntrance(), useWeeMotion() (+15 more)
...
Cohesion: 0.13
Nodes (23): HomeBoardArrangeBar(), HomeSlot(), legacyChannelConfigFromSlot(), WIDGET_SLOT_COMPONENTS, homeSlotKindHasWidgetSettings(), getHomeSlotKind(), getHomeSlotSizePreset(), GLANCE_TILE_SIZE_PRESETS (+15 more)

### Community 32 - "keyboardShortcuts.js"
Cohesion: 0.25
Nodes (13): DEFAULT_CHANNEL_NAVIGATION, WII_LAYOUT_PRESET, CHANNEL_SPACE_KEYS, createDefaultChannelSpaceData(), getChannelDataSlice(), getSecondaryChannelSpaceData(), migrateLegacyChannelsToDataBySpace(), normalizeChannelSpaceData() (+5 more)
...
Cohesion: 0.27
Nodes (14): buildHubDisplayMedia(), GameHubGameArtPanel(), readStoredArtSubtab(), MediaItem(), useChannelModalMedia(), resolveMimeTypeFromMediaLibraryRow(), uploadFileToMediaLibraryRow(), getStoragePublicObjectUrl() (+6 more)
...
Cohesion: 0.14
Nodes (14): AdvancedSettingsTab, QUICK_LINKS, DEFAULT_GLASS, SIDE_NAV_STYLE_OPTIONS, SettingsTabPageHeader(), SettingsWeeSection(), SOUND_CATEGORY_DESCRIPTIONS, SOUND_CATEGORY_ICONS (+6 more)
...
### Community 59 - "react"
Cohesion: 0.17
Nodes (20): useGlobalKeyHandlers(), usePrimaryAccentThemeEffect(), useThemeEffect(), useWallpaperAmbientColor(), syncActiveSpaceAppearanceCapture(), closeTopOverlayOnEscape(), handleShellEscapeKey(), adjustL() (+12 more)

### Community 72 - "cors"
Cohesion: 0.18
Nodes (11): @dnd-kit/core, framer-motion, fs-extra, jszip, dependencies, @dnd-kit/core, framer-motion, fs-extra (+3 more)
...
Cohesion: 0.14
Nodes (25): LaunchErrorToast(), HomeWidgetShell, LAUNCH_TYPE_FALLBACK_ICONS, RecentlyUsedSlot(), FriendPlayingCard(), SteamFriendsSlot(), SteamCoverButton(), SteamGamesGlanceSlot() (+17 more)

### Community 78 - "framer-motion"
Cohesion: 0.24
Nodes (14): saveUnifiedSoundSettings(), hydrateSoundLibrary(), listeners, notify(), refreshSoundLibrary(), sanitizeLibrary(), setSoundLibraryCache(), subscribeSoundLibrary() (+6 more)

### Community 79 - "fs-extra"
Cohesion: 0.15
Nodes (24): AdminPanel(), EMPTY_CUSTOM, ActionCommand(), QuickAccessItem(), AdminQuickAccessSlot(), layoutCellsForPreset(), splitActionsByCapacity(), AuthModal() (+16 more)

### Community 80 - "fuse.js"
Cohesion: 0.21
Nodes (16): SpotifyTakeoverController(), CommandPalette(), executeAdminCommand(), buildCommandCatalog(), channelTitleFromSlot(), COMMAND_GROUPS, EXCLUDED_SHORTCUT_IDS, filterAndGroupCommands() (+8 more)

### Community 81 - "gifuct-js"
Cohesion: 0.13
Nodes (15): albumArtPaletteCache, clearAlbumArtPaletteCache(), getAlbumArtPaletteCacheSize(), clearCachedSteamClientLibrary(), refreshSteamEnrichmentNow(), clearTintedIconCache(), getTintedIconCacheSize(), IDLE_EXPERIENCE_MODES (+7 more)
...
Cohesion: 0.24
Nodes (7): DEFAULT_BUTTON_CONFIGS, formatDate(), formatTime(), RibbonMiniature(), useHostWidth(), WiiStyleButton(), hexAlpha()

### Community 85 - "p-queue"
Cohesion: 0.17
Nodes (15): ClassicWiiDock(), IsolatedWallpaperBackground, IsolatedWallpaperBackgroundInner(), spaceParallaxBackgroundYPercent(), ClassicDockLivePreview(), RibbonLivePreview(), SettingsLivePreviewFrame(), useWallpaperSettingsController() (+7 more)

### Community 86 - "prop-types"
Cohesion: 0.09
Nodes (46): p-queue, p-queue, base, m, patch, HomeWidgetGlassControls(), hasPatchSettingsApi(), selectPersistedSlices() (+38 more)
...
Cohesion: 0.18
Nodes (20): useChannelInteractions(), DefaultLeftIcon(), DefaultRightIcon(), rgbToRgba(), WiiSideNavigation(), useChannelSpaceKey(), useChannelModalHoverSound(), getRecentLaunchHintTtlMs() (+12 more)
...
Cohesion: 0.24
Nodes (12): ChannelModalChannelArtPanel(), readStoredArtSubtab(), MediaLibraryBrowser(), ImageSearchModal(), MEDIA_LIBRARY_FILETYPE_OPTIONS, MEDIA_LIBRARY_PAGE_SIZE_OPTIONS, MEDIA_LIBRARY_SORT_OPTIONS, useMediaLibraryBrowser() (+4 more)
...
Cohesion: 0.12
Nodes (9): Channel, CHANNEL_ANIMATION_STYLES, ChannelModalsHost(), VirtualizedChannelList, ChannelSpaceContext, ChannelSpaceProvider(), performanceChecklist, performanceUtils (+1 more)
...
Cohesion: 0.29
Nodes (11): WiiRibbonComponent(), PrimaryActionsModalComponent(), extractColorsFromAlbumArt(), analyzeIconTransparency(), clampSampleSize(), getTintedIconUrl(), loadImageElement(), parseColorToRgb() (+3 more)
...
Cohesion: 0.31
Nodes (6): WiiDock(), DockParticleSystem, LazyPrimaryActionsModal, WiiRibbon, getWeeDockBarEntrance(), toDockParticleProps()

### Community 183 - "AuraHubModalFrame.jsx"
Cohesion: 0.09
Nodes (13): CommunityPresets(), PresetListItem, ImageModal(), SecondaryChannelProfilesCard, Text(), variantMap, buttonVariants, variantSecondarySurface (+5 more)

### Community 185 - "wait-on"
Cohesion: 0.31
...
- **Why does `dependencies` connect `cors` to `UnifiedDockSettingsTab.jsx`, `WeeModalShell.jsx`, `ChannelsLayoutSettingsTab.jsx`, `cacheDomains.js`, `package.json`, `useHomeWeather.js`, `uuid`, `mediaHubStremio.js`, `1. THE THREE DIALS (Core Configuration)`, `cors`, `better-sqlite3`, `cors`, `spotify-web-api-js`, `@tanstack/react-virtual`, `gifuct-js`, `lucide-react`, `prop-types`, `fast-deep-equal`, `@dnd-kit/utilities`, `electron-updater`, `express`, `node-fetch`, `prop-types`, `@radix-ui/react-context-menu`, `react-dom`, `sharp`, `systeminformation`, `vdf`, `windows-shortcuts`, `zustand`?**
