...
## Corpus Check
- 463 files · ~308,334 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2567 nodes · 5825 edges · 200 communities (143 shown, 57 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 80 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c0d38a8e`
...
## Communities (200 total, 57 thin omitted)

### Community 0 - "PresetsSettingsTab.jsx"
Cohesion: 0.06
Nodes (70): PresetsCommunityCard, PresetsSaveCurrentCard, PresetsSavedListCard, PresetsSpotifyMatchSection, PRESET_UPDATE_SCOPE_OPTIONS, SecondaryChannelProfilesCard, WorkspaceSwitcherModal(), captureSpaceAppearanceFromState() (+62 more)
...
Cohesion: 0.18
Nodes (16): LaunchErrorToast(), LAUNCH_TYPE_FALLBACK_ICONS, RecentlyUsedSlot(), sortRecentSteamGames(), STEAM_CDN_CAPSULE(), SteamCapsuleButton(), SteamRecentSlot(), CommandPalette() (+8 more)

### Community 3 - "FloatingSpotifyWidget.jsx"
Cohesion: 0.08
Nodes (12): UnifiedAppPathSearch(), CHROME_EFFECT_OPTIONS, SettingsLivePreviewFrame(), WeeButton(), readCollapseDurationMs(), WeeContentCollapse(), sizeClasses, WeeEmphasisText() (+4 more)

### Community 4 - "WiiRibbon.jsx"
Cohesion: 0.18
Nodes (14): WiiRibbonComponent(), PrimaryActionsModal, PrimaryActionsModalComponent(), WeeSlider(), WeeToggle(), analyzeIconTransparency(), clampSampleSize(), getTintedIconUrl() (+6 more)

### Community 6 - "WallpaperSettingsTab.jsx"
Cohesion: 0.05
Nodes (63): useChannelInteractions(), GameHubMinimalDock(), DefaultLeftIcon(), DefaultRightIcon(), rgbToRgba(), WiiSideNavigation(), SpotifyGradientOverlay(), SpotifyImmersiveOverlay() (+55 more)

### Community 7 - "AuraCollectionsSection.jsx"
Cohesion: 0.19
Nodes (15): AuraLibrarySection(), GameHubSpace(), smoothstep01(), useMinWidthDockMorph(), orderHubCollectionItems(), sortHubGamesByName(), useHeroMediaCrossfade(), createGameHubMorphLibraryFollowVariants() (+7 more)
...
Cohesion: 0.09
Nodes (16): DevReactProfiler(), ChannelsLayoutSettingsTab, ColorsSettingsTab, GeneralSettingsTab, MonitorSettingsTab, MotionFeedbackSettingsTab, NavigationPillSettingsTab, PresetsSettingsTab (+8 more)

### Community 11 - "AdminPanel.jsx"
Cohesion: 0.10
Nodes (35): AuraCollectionsSection(), nextFrame(), preloadGameArt(), shouldIgnoreCollectionCloseTarget(), waitMs(), AuraGameCard, COLLECTION_FLY_PHASE_MS, defaultFlyLayerParent() (+27 more)
...
Cohesion: 0.10
Nodes (27): MediaLibraryBrowser(), SpotifyLiveGradientWallpaper(), NavigationSettingsTab(), formatMessage(), logError(), logWarn(), registerSpotifyGradientSave(), SPOTIFY_SCOPES (+19 more)

### Community 17 - "index.js"
Cohesion: 0.20
Nodes (9): ClassicWiiDock(), WiiDock(), DockParticleSystem, LazyPrimaryActionsModal, WiiRibbon, CLASSIC_DOCK_THEME_GROUPS, CLASSIC_DOCK_DEFAULT_COLORS, getWeeDockBarEntrance() (+1 more)
...
Cohesion: 0.18
Nodes (11): UnifiedAppPathCard, ChannelModal(), ChannelModalUnifiedPathBlock(), ChannelModalsHost(), ChannelPathSmartSuggestions(), useChannelModalInitialization(), getSmartPathSuggestions(), inferLaunchTypeFromPath() (+3 more)
...
Cohesion: 0.20
Nodes (21): buildChannelPayload(), channelToConfiguredEntry(), channelToKenBurnsEntry(), createAdminQuickAccessSlot(), createChannelSlotFromLegacy(), createEmptyChannelSlot(), createHomeWidgetSlot(), ensureSpaceDataSlots() (+13 more)

### Community 26 - "GameHubGameArtPanel.jsx"
Cohesion: 0.15
Nodes (16): CHANNEL_ANIMATION_STYLES, buildKenBurnsProps(), ChannelMediaPreview(), useChannelAdaptiveEmptyStyle(), useChannelEffectiveState(), clearMp4PosterCache(), mp4PosterCache, readCachedPoster() (+8 more)
...
Cohesion: 0.22
Nodes (18): PageNavigation(), SlideNavigation(), applyLayoutChangeToSpaceData(), CHANNEL_LAYOUT_LIMITS, channelIdAtIndex(), clampInt(), clampPageIndex(), getChannelsPerPage() (+10 more)

### Community 29 - "useWeeMotion"
Cohesion: 0.16
Nodes (20): HomePageIndicator(), statusLabel(), UpdateModal(), WeeUpdateProgress(), LayoutStepper(), createWeeSideNavPeekVariants(), createWeeSideNavShellMotion(), createWeeTransition() (+12 more)
...
Cohesion: 0.25
Nodes (14): WiiChannelStrip(), HomeSlotResizeHandle(), BoardLivePreview(), createWeeChannelTileItemVariants(), useHomeSlotResize(), isSlotHidden(), applySlotSpan(), buildOccupancyMap() (+6 more)
...
Cohesion: 0.24
Nodes (12): IsolatedWallpaperBackground, IsolatedWallpaperBackgroundInner(), spaceParallaxBackgroundYPercent(), ClassicDockLivePreview(), RibbonLivePreview(), useWallpaperSettingsController(), useSpaceWallpaperCrossfade(), DEFAULT_SHELL_SPACE_ORDER (+4 more)
...
Cohesion: 0.16
Nodes (15): AdvancedSettingsTab, IDLE_TYPE_ITEMS, KEN_BURNS_EASING_OPTIONS, KEN_BURNS_MODE_OPTIONS, QUICK_LINKS, DEFAULT_GLASS, SIDE_NAV_STYLE_OPTIONS, SettingsTabPageHeader() (+7 more)
...
### Community 59 - "react"
Cohesion: 0.16
Nodes (19): usePrimaryAccentThemeEffect(), useWallpaperAmbientColor(), albumArtPaletteCache, clearAlbumArtPaletteCache(), getAlbumArtPaletteCacheSize(), adjustL(), applyPrimaryAccentFromHex(), fmt() (+11 more)
...
Cohesion: 0.24
Nodes (14): HomeBoardArrangeBar(), HomeSlot(), legacyChannelConfigFromSlot(), WIDGET_SLOT_COMPONENTS, getHomeSlotKind(), getHomeSlotSizePreset(), GLANCE_TILE_SIZE_PRESETS, HOME_SLOT_KINDS (+6 more)

### Community 78 - "framer-motion"
Cohesion: 0.22
Nodes (13): ClockSlot(), formatClockDate(), formatClockTime(), HomeWidgetShell, NowPlayingSlot(), formatTemp(), WeatherSlot(), DEFAULT_TIME_COLOR_HEX (+5 more)

### Community 80 - "fuse.js"
Cohesion: 0.29
Nodes (8): ChannelModalBehaviorTab(), enterSessionAwayIfIntensive(), CASUAL_EXE_NAMES, GAME_PATH_MARKERS, getAutoPerformancePauseHint(), isIntensiveLaunchTarget(), PERFORMANCE_PAUSE_MODES, resolveChannelPerformancePause()
...
Cohesion: 0.12
Nodes (40): base, m, patch, hasPatchSettingsApi(), selectPersistedSlices(), useUnifiedSettingsPersistence(), debounceWaiters, flushDebouncedSettingsWrites() (+32 more)

### Community 87 - "@radix-ui/react-context-menu"
Cohesion: 0.23
Nodes (10): getTintedIconCacheSize(), IDLE_EXPERIENCE_MODES, IDLE_PERSONALITY_PACKS, matchIdlePersonality(), normalizeIdleExperienceSettings(), LAUNCH_FEEDBACK_MODES, normalizeLaunchFeedbackMode(), deriveLaunchLabel() (+2 more)
...
Cohesion: 0.30
Nodes (8): FloatingWidgetPresence, GLASS_TEST_BTN_STYLE, SystemInfoWidget(), defaultUncontrolledSize(), useFloatingWidgetFrame(), viewportResizeBounds(), clampFloatingWidgetPosition(), getViewportSize()

### Community 128 - "SystemInfoWidget.jsx"
Cohesion: 0.12
Nodes (10): DIRECTION_OPTIONS, EFFECT_TYPE_OPTIONS, DOCK_SUB_TABS, UnifiedDockSettingsTab, GooeySettingsRow(), Slider(), WeeChoiceTileGrid(), WeeIconHeadingRow() (+2 more)
...
Cohesion: 0.21
Nodes (9): WeeChannelModal(), AuraHubModalFrame(), GameHubRenameCollectionDialog(), WEE_VARIANTS, useDialogExitPresence(), variantNameFromDefinition(), WeeModalRail(), WeeModalRailItem() (+1 more)
...
Cohesion: 0.17
Nodes (21): elementCanScrollVertically(), getNextSpaceId(), isTypingTarget(), useWheelNavigation(), DEFAULT_CHANNEL_NAVIGATION, WII_LAYOUT_PRESET, CHANNEL_SPACE_KEYS, createDefaultChannelSpaceData() (+13 more)
...
Cohesion: 0.29
Nodes (5): GameHubSettingsTab, openExternalUrl(), openSpotifyWebApp(), parseSteamId64(), validateSteamId64Input()

### Community 178 - "jszip"
Cohesion: 0.57
Nodes (4): HomeWidgetGlassControls(), DEFAULT_HOME_WIDGET_GLASS, homeWidgetGlassCssVars(), normalizeHomeWidgetGlass()

### Community 182 - "openSettingsToTab"
Cohesion: 0.52
Nodes (5): toggleHomeBoardArrange(), useHomeBoardArrange(), handleGlobalShortcut(), openSettingsToTab(), useKeyboardShortcuts()

### Community 183 - "AuraHubModalFrame.jsx"
Cohesion: 0.09
Nodes (18): CommunityPresets(), PresetListItem, AuthModal(), ConfirmationModal(), ImageModal(), Text(), variantMap, buttonVariants (+10 more)

### Community 184 - "useHomeWeather.js"
Cohesion: 0.52
...
### Community 190 - "5. Materials & color"
Cohesion: 0.33
...
### Community 193 - "homeWidgetSurface.js"
Cohesion: 0.53
