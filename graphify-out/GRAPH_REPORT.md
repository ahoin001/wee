...
## Corpus Check
- 486 files · ~329,611 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2745 nodes · 6494 edges · 212 communities (156 shown, 56 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 89 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a906210d`
...
Cohesion: 0.17
Nodes (19): AuraCollectionsSection(), nextFrame(), preloadGameArt(), shouldIgnoreCollectionCloseTarget(), waitMs(), AuraGameCard, COLLECTION_FLY_PHASE_MS, CollectionShelfContextMenu() (+11 more)

### Community 1 - "useConsolidatedAppStore.js"
Cohesion: 0.24
Nodes (13): GameHubMinimalDock(), PerformanceMonitor(), useActivityInterval(), getInitialActivity(), getInitialMainWindowActivity(), useAppActivity(), useHomeIdleExperience(), usePowerPolicy() (+5 more)

### Community 2 - "PaginatedChannels.jsx"
Cohesion: 0.23
Nodes (12): ChannelDragOverlayFrame(), ChannelDropTargetMotion(), ChannelReorderVfxPortal(), measureChannelSlotCenter(), channelDragId(), ChannelSlotDnd(), channelSlotId(), parseChannelDnDId() (+4 more)

### Community 3 - "FloatingSpotifyWidget.jsx"
Cohesion: 0.05
Nodes (102): WiiChannelStrip(), HomeSlotResizeHandle(), RESIZE_CORNERS, PageNavigation(), SlideNavigation(), DefaultLeftIcon(), DefaultRightIcon(), rgbToRgba() (+94 more)
...
Cohesion: 0.11
Nodes (19): GooeyFloatingPanel(), FloatingSpotifyWidget(), SpotifyBrowseView(), SpotifyMiniPlayerBar(), SpotifySettingsView(), SpotifyWidgetChrome(), getGooeyMintPalette(), GOOEY_HUB_CLASSIC_MINT (+11 more)
...
Cohesion: 0.14
Nodes (12): DevReactProfiler(), ColorsSettingsTab, GeneralSettingsTab, MonitorSettingsTab, NavigationPillSettingsTab, PresetsSettingsTab, SETTINGS_TAB_COMPONENTS, SETTINGS_TAB_IDS (+4 more)
...
Cohesion: 0.16
Nodes (19): applyAmbientEntry(), resolveBoardTotalPages(), useWallpaperAmbientColor(), albumArtPaletteCache, getAlbumArtPaletteCacheSize(), applyAmbientRoleTokens(), colorStringToHex(), DEFAULT_AMBIENT_COLOR (+11 more)
...
Cohesion: 0.33
Nodes (7): buildKenBurnsProps(), ChannelMediaPreview(), KenBurnsImage(), PAN_DIRECTIONS, isGifMediaType(), isRasterImageMediaType(), isVideoMediaType()
...
Cohesion: 0.25
Nodes (11): AuraLibrarySection(), GameHubSpace(), smoothstep01(), useMinWidthDockMorph(), orderHubCollectionItems(), sortHubGamesByName(), useHeroMediaCrossfade(), isAppLibraryBackgroundPrefetchScheduled() (+3 more)
...
Cohesion: 0.19
Nodes (9): DEFAULT_BUTTON_CONFIGS, formatDate(), formatTime(), RibbonMiniature(), useHostWidth(), cubicPoint(), sampleRibbonTopEdgeForCanvas(), sampleRibbonTopEdgePoints() (+1 more)
...
Cohesion: 0.14
Nodes (14): ChannelModal(), ChannelModalUnifiedPathBlock(), useChannelModalInitialization(), useChannelModalMedia(), getSmartPathSuggestions(), inferLaunchTypeFromPath(), normalizeChannelPath(), validateChannelPath() (+6 more)
...
Cohesion: 0.15
Nodes (12): ChannelsLayoutSettingsTab, IDLE_TYPE_ITEMS, KEN_BURNS_EASING_OPTIONS, KEN_BURNS_MODE_OPTIONS, LayoutStepper(), CHROME_EFFECT_OPTIONS, RibbonDockPanel(), WeeHelpLinkButton() (+4 more)
...
Cohesion: 0.16
Nodes (25): chromeForSize(), EMPTY_SYSTEM_SESSIONS, formatMs(), NowPlayingSlot(), useNowPlayingColorMatch(), toStoredSession(), useNowPlayingSources(), useSharedSpotifyPlaybackSampler() (+17 more)
...
Cohesion: 0.26
Nodes (16): cloneJson(), COMMUNITY_ALLOWED_KEYS, COMMUNITY_BLOCKED_KEYS, fileFromBase64(), getPresetWallpaperUrl(), isHttpUrl(), isPlainObject(), isUserdataUrl() (+8 more)
...
Cohesion: 0.22
Nodes (13): ChannelModalSuggestedGames(), dedupeInstalledAgainstStores(), filterGames(), getSuggestedCarouselKey(), paginateGames(), sortGames(), SOURCE_FILTER, MediaItem() (+5 more)

### Community 43 - "logWarn"
Cohesion: 0.22
Nodes (13): buildHubDisplayMedia(), GameHubGameArtPanel(), readStoredArtSubtab(), ImageSearchModal(), MEDIA_LIBRARY_FILETYPE_OPTIONS, MEDIA_LIBRARY_PAGE_SIZE_OPTIONS, MEDIA_LIBRARY_SORT_OPTIONS, useMediaLibraryBrowser() (+5 more)
...
Cohesion: 0.05
Nodes (58): SpotifyImmersiveOverlay(), SpotifyTakeoverController(), formatLastRefreshed(), SCOPE_LABELS, SettingsDataCachesCard(), SettingsModal(), useSpotifyPlaybackSample(), actionStamps (+50 more)
...
Cohesion: 0.60
Nodes (5): adjustL(), applyPrimaryAccentFromHex(), fmt(), hexToRgb(), rgbToHslComponents()
...
Cohesion: 0.14
Nodes (20): getRibbonChromeEffectDefaults(), getRibbonChromeEffectMeta(), getRibbonChromeEffectOptions(), isRibbonChromeEffectId(), isRibbonChromeGlassSoftMode(), isRibbonNeonColorMode(), META_BY_ID, RIBBON_CHROME_EFFECTS (+12 more)

### Community 75 - "@dnd-kit/utilities"
Cohesion: 0.14
Nodes (19): EMPTY_FRIENDS_PLAYING, FriendListRow(), EMPTY_ENRICHED_GAMES, VARIANT_META, SteamCoverTile(), SteamGamesShelf(), WeeFadeScroll, refreshSteamEnrichmentNow() (+11 more)

### Community 76 - "electron-updater"
Cohesion: 0.17
Nodes (16): NowPlayingWidgetSettings(), PresetsCommunityCard, PresetsSaveCurrentCard, PresetsSavedListCard, PresetsSpotifyMatchSection, PRESET_UPDATE_SCOPE_OPTIONS, importCommunityPresetFlow(), normalizeCommunitySettings() (+8 more)
...
Cohesion: 0.14
Nodes (16): WiiDock(), DockParticleSystem, PARTICLE_TYPES, LazyPrimaryActionsModal, WiiRibbon, WiiRibbonComponent(), WiiStyleButton(), PrimaryActionsModalComponent() (+8 more)

### Community 80 - "spaceAppearance.js"
Cohesion: 0.11
Nodes (21): AdvancedSettingsTab, QUICK_LINKS, GameHubSettingsTab, NavigationSettingsTab, SettingsTabPageHeader(), SettingsToggleFieldCard(), SettingsWeeSection(), SpaceWallpaperAppearanceSection() (+13 more)
...
Cohesion: 0.13
Nodes (13): UnifiedAppPathCard, UnifiedAppPathSearch(), ChannelModalChannelArtPanel(), readStoredArtSubtab(), ChannelPathSmartSuggestions(), PrimaryActionsModal, WeeButton(), WeeSectionEyebrow() (+5 more)

### Community 86 - "prop-types"
Cohesion: 0.08
Nodes (52): base, m, patch, HomeWidgetGlassControls(), buildChannelPatchFromNormalized(), useAppInitialization(), CHANNEL_SPACE_KEYS, createDefaultChannelSpaceData() (+44 more)

### Community 87 - "@radix-ui/react-context-menu"
Cohesion: 0.09
Nodes (30): ChannelModalBehaviorTab(), WeeChannelModal(), GameHubControlsPill(), HomePageIndicator(), statusLabel(), UpdateModal(), WeeUpdateProgress(), createWeeSideNavPeekVariants() (+22 more)

### Community 88 - "experience-roadmap-invariants.mjs"
Cohesion: 0.23
Nodes (13): ClockSlot(), formatClockDate(), formatClockTime(), HomeWidgetShell, DEFAULT_TIME_COLOR_HEX, HOME_WIDGET_SURFACES, isNonChannelSlotLike(), migrateChannelsLegacyGlassSurfaces() (+5 more)
...
Cohesion: 0.31
Nodes (6): AuraHubModalFrame(), GameHubManageCollectionsDialog(), FloatingWidgetPresence, WEE_VARIANTS, useDialogExitPresence(), variantNameFromDefinition()
...
Cohesion: 0.19
Nodes (18): HomeWidgetSettingsPanel(), STEAM_KIND_IDS, SteamWidgetSettings(), WeatherWidgetSettings(), WeatherSlot(), useHomeWeather(), DEFAULT_HOME_STEAM_WIDGET, HOME_STEAM_GUTTERS (+10 more)

### Community 94 - "saveFrozenSpotifyLookPreset.js"
Cohesion: 0.16
Nodes (24): MANUAL, SPOTIFY, WALLPAPER_PALETTE, useWallpaperSettingsController(), hasExplicitPageRibbonLook(), mergeSpaceScopedRibbonFields(), normalizeRibbonByPage(), normalizeRibbonScope() (+16 more)
...
Cohesion: 0.24
Nodes (11): EMPTY_RECENT_LAUNCHES, LAUNCH_TYPE_FALLBACK_ICONS, RecentlyUsedSlot(), SteamFriendsSlot(), SteamGamesGlanceSlot(), CommandPalette(), EMPTY_PALETTE_RECENTS, useLaunchFeedback() (+3 more)
...
Cohesion: 0.36
Nodes (10): getSecondaryChannelSpaceData(), normalizeChannelSpaceData(), appearanceForSpace(), buildPresetDataFromStore(), buildPresetFromCurrentStore(), cloneChannelBoardForPreset(), cloneSafe(), buildWorkspaceDataFromStore() (+2 more)
...
Cohesion: 0.38
Nodes (7): applyPresetData(), normalizeSettingsShape(), isPresetScopeWithHomeChannels(), normalizePresetScope(), normalizePresetSoundsSnapshot(), pickSoundSettings(), SOUND_SETTINGS_KEYS
...
### Community 173 - "settingsRegistry.js"
Cohesion: 0.50
...
Cohesion: 0.07
Nodes (26): EMPTY_CUSTOM, ActionCommand(), CommunityPresets(), PresetListItem, QuickAccessItem(), MediaLibraryBrowser(), AuthModal(), ConfirmationModal() (+18 more)

### Community 186 - "ribbonSilhouette.js"
Cohesion: 0.24
Nodes (5): DOCK_SUB_TABS, UnifiedDockSettingsTab, WeeChoiceTileGrid(), findDockThemePath(), getDockThemeByPath()

### Community 189 - "WiiSideNavigation.jsx"
Cohesion: 0.31
Nodes (6): SettingsActionMenu, countCustomPresets(), defaultAtmosphereLookName(), saveCurrentAtmosphereLookPreset(), capturePresetThumbnailDataUrl(), waitForNextPaint()

### Community 193 - "WorkspaceSwitcherModal.jsx"
Cohesion: 0.33
...
### Community 194 - "concurrently"
Cohesion: 0.39
Nodes (7): useGlobalKeyHandlers(), handleGlobalShortcut(), closeTopOverlayOnEscape(), handleShellEscapeKey(), isBlockingOverlayOpen(), EMPTY_KEYBOARD_SHORTCUTS, useKeyboardShortcuts()

### Community 195 - "HomeSlot.jsx"
Cohesion: 0.29
Nodes (3): HomeSlot(), legacyChannelConfigFromSlot(), WIDGET_SLOT_COMPONENTS

### Community 198 - "ChannelReorderVfx.jsx"
Cohesion: 0.46
...
## Knowledge Gaps
- **844 isolated node(s):** `PLAYLISTS`, `SONGS`, `name`, `version`, `main` (+839 more)
...
- **Why does `dependencies` connect `WorkspaceSwitcherModal.jsx` to `WiiDesktop Launcher`, `Features Available`, `ChannelsLayoutSettingsTab.jsx`, `cacheDomains.js`, `PaginatedChannels.jsx`, `package.json`, `weePerformanceMarks.js`, `HomeSlot.jsx`, `settingsRegistry.js`, `spotify-web-api-js`, `useSessionPowerSync.js`, `useHubSpaceEntrance.js`, `mediaHubStremio.js`, `systeminformation`, `windows-media-sessions`, `fast-average-color`, `[Unreleased]`, `useIdleChannelAnimations.js`, `gifuct-js`, `electron-updater`, `fast-deep-equal`, `fs-extra`, `windows-media-sessions`, `react-icons`, `@dnd-kit/sortable`, `sharp`, `windows-shortcuts`, `zustand`, `react-dom`, `nowPlayingShape.js`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `react` connect `weePerformanceMarks.js` to `@dnd-kit/utilities`, `WorkspaceSwitcherModal.jsx`, `6. Styling advice by UI type`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `WiiRibbonComponent()` connect `6. Styling advice by UI type` to `keyboardShortcuts.js`, `ChannelModalChannelArtPanel.jsx`, `WiiRibbon.jsx`, `useActivityInterval`, `@dnd-kit/sortable`, `ChannelModal.jsx`, `weePerformanceMarks.js`, `WallpaperSettingsTab.jsx`, `supabase.js`, `WeeModalFieldCard`, `useFloatingWidgetFrame`, `@radix-ui/react-context-menu`, `GameHubSpace.jsx`, `Channel.jsx`, `useWeeMotion`, `saveFrozenSpotifyLookPreset.js`?**
...
- **Should `FloatingSpotifyWidget.jsx` be split into smaller, more focused modules?**
  _Cohesion score 0.051077089825226935 - nodes in this community are weakly interconnected._
