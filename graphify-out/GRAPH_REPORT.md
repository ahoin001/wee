...
## Corpus Check
- 460 files · ~306,628 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2553 nodes · 5777 edges · 195 communities (139 shown, 56 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 79 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `26fdbd82`
...
3. `useMotionFeedback()` - 45 edges
4. `useWeeMotion()` - 43 edges
5. `WButton` - 43 edges
6. `App()` - 34 edges
7. `scripts` - 33 edges
...
- `MediaItem()` --calls--> `getStoragePublicObjectUrl()`  [EXTRACTED]
  src/components/media/MediaLibraryBrowser.jsx → src/utils/supabase.js
...
Cohesion: 0.17
Nodes (20): PresetsSpotifyMatchSection, PRESET_UPDATE_SCOPE_OPTIONS, importCommunityPresetFlow(), normalizeCommunitySettings(), buildPresetFilePayload(), exportPresetToFile(), parsePresetFile(), safeFileName() (+12 more)
...
Cohesion: 0.11
Nodes (10): UnifiedAppPathCard, UnifiedAppPathSearch(), PrimaryActionsModal, SettingsActionMenu, VARIANT_MAP, WeeButton(), WeeSectionEyebrow(), WeeSlider() (+2 more)

### Community 4 - "WiiRibbon.jsx"
Cohesion: 0.19
Nodes (18): NowPlayingSlot(), SpotifyTakeoverController(), buildCommandCatalog(), channelTitleFromSlot(), COMMAND_GROUPS, EXCLUDED_SHORTCUT_IDS, fuzzyScore(), scoreCommand() (+10 more)

### Community 6 - "WallpaperSettingsTab.jsx"
Cohesion: 0.17
Nodes (23): useChannelModalHoverSound(), findEnabledSound(), getEnabledBackgroundTracks(), getSoundLibrarySync(), hydrateSoundLibrary(), listeners, notify(), refreshSoundLibrary() (+15 more)

### Community 7 - "AuraCollectionsSection.jsx"
Cohesion: 0.05
Nodes (64): AuraCollectionsSection(), nextFrame(), preloadGameArt(), shouldIgnoreCollectionCloseTarget(), waitMs(), AuraGameCard, AuraHero(), buildHeroStats() (+56 more)
...
Cohesion: 0.14
Nodes (18): ColorsSettingsTab, GeneralSettingsTab, MonitorSettingsTab, NavigationPillSettingsTab, PresetsSettingsTab, SETTINGS_TAB_COMPONENTS, SETTINGS_TAB_IDS, SettingsModal() (+10 more)

### Community 11 - "AdminPanel.jsx"
Cohesion: 0.22
Nodes (15): HomeBoardArrangeBar(), HomeSlot(), legacyChannelConfigFromSlot(), WIDGET_SLOT_COMPONENTS, getHomeSlotKind(), getHomeSlotSizePreset(), GLANCE_TILE_SIZE_PRESETS, HOME_SLOT_KINDS (+7 more)
...
Cohesion: 0.12
Nodes (13): GooeyFloatingPanel(), FloatingSpotifyWidget(), SpotifyBrowseView(), SpotifyMiniPlayerBar(), SpotifyWidgetChrome(), useMusicReactiveLevels(), ZERO_LEVELS, usePlaybackSeek() (+5 more)

### Community 16 - "supabase.js"
Cohesion: 0.10
Nodes (26): SpotifyLiveGradientWallpaper(), NavigationSettingsTab(), formatMessage(), logError(), logWarn(), pruneMediaPageCache(), registerSpotifyGradientSave(), SPOTIFY_SCOPES (+18 more)
...
Cohesion: 0.10
Nodes (31): MediaHubDiscoverGrid(), EMPTY_OBJECT, episodesForSeason(), formatImdbRating(), getPosterUrl(), GRID_LIST_PARENT_VARIANTS, MediaHubItemDetail(), MediaHubSpace() (+23 more)

### Community 19 - "WeeModalFieldCard"
Cohesion: 0.11
Nodes (18): ChannelsLayoutSettingsTab, IDLE_TYPE_ITEMS, KEN_BURNS_EASING_OPTIONS, KEN_BURNS_MODE_OPTIONS, DIRECTION_OPTIONS, EFFECT_TYPE_OPTIONS, MotionFeedbackSettingsTab, SettingsToggleFieldCard() (+10 more)

### Community 20 - "managers.js"
Cohesion: 0.27
Nodes (13): toStoredSession(), useNowPlayingSources(), EMPTY_NOW_PLAYING, hasTrack(), normalizeNowPlaying(), normalizeNowPlayingSourcePreference(), NOW_PLAYING_SOURCE_PREFERENCES, NOW_PLAYING_SOURCES (+5 more)
...
Cohesion: 0.20
Nodes (18): ClockSlot(), formatClockDate(), formatClockTime(), HomeWidgetShell, LAUNCH_TYPE_FALLBACK_ICONS, RecentlyUsedSlot(), sortRecentSteamGames(), STEAM_CDN_CAPSULE() (+10 more)
...
Cohesion: 0.09
Nodes (29): HomePageIndicator(), statusLabel(), UpdateModal(), BoardLivePreview(), LayoutStepper(), HUB_MORPH, PLAYFUL_AMPLITUDE, PLAYFUL_SPRINGS (+21 more)
...
Cohesion: 0.17
Nodes (24): buildChannelPayload(), channelToConfiguredEntry(), channelToKenBurnsEntry(), createAdminQuickAccessSlot(), createChannelSlotFromLegacy(), createEmptyChannelSlot(), createHomeWidgetSlot(), ensureSpaceDataSlots() (+16 more)

### Community 33 - "Text.jsx"
Cohesion: 0.23
Nodes (12): SpaceWallpaperAppearanceSection(), WallpaperCyclingSection(), WallpaperLibrarySection(), WallpaperOverlaySection(), EASING_OPTIONS, OVERLAY_EFFECT_OPTIONS, SLIDE_DIRECTION_MODE_OPTIONS, SLIDE_DIRECTION_OPTIONS (+4 more)
...
Cohesion: 0.25
Nodes (15): buildCandidateTerms(), buildQueryTokens(), ChannelModalInlineMediaSuggestions(), formatMediaKind(), normalizeText(), rowKey(), rowPublicUrl(), scoreFallbackMedia() (+7 more)
...
Cohesion: 0.21
Nodes (9): computeSpaceRailContentHeight(), getNextSpace(), maxSpaceRailViewportHeight(), SPACE_META, SPACE_RAIL_LAYOUT, WeeGooeySpacePill(), createWeeShellRailContainerVariants(), createWeeShellRailItemVariants() (+1 more)
...
Cohesion: 0.20
Nodes (12): IsolatedWallpaperBackground, IsolatedWallpaperBackgroundInner(), spaceParallaxBackgroundYPercent(), ClassicDockLivePreview(), RibbonLivePreview(), SettingsLivePreviewFrame(), useSpaceWallpaperCrossfade(), DEFAULT_SHELL_SPACE_ORDER (+4 more)

### Community 40 - "AuthService"
Cohesion: 0.23
Nodes (18): capturePresetThumbnailDataUrl(), cloneJson(), COMMUNITY_ALLOWED_KEYS, COMMUNITY_BLOCKED_KEYS, fileFromBase64(), getPresetWallpaperUrl(), isHttpUrl(), isPlainObject() (+10 more)
...
Cohesion: 0.16
Nodes (20): ChannelModalChannelArtPanel(), readStoredArtSubtab(), deriveChannelArtSearchQuery(), MediaItem(), MediaLibraryBrowser(), ImageSearchModal(), useChannelModalMedia(), MEDIA_LIBRARY_FILETYPE_OPTIONS (+12 more)
...
Cohesion: 0.19
Nodes (9): WeeUpdateProgress(), AdvancedSettingsTab, QUICK_LINKS, GameHubSettingsTab, DEFAULT_GLASS, SIDE_NAV_STYLE_OPTIONS, SettingsTabPageHeader(), SettingsWeeSection() (+1 more)
...
### Community 59 - "react"
Cohesion: 0.21
Nodes (16): usePrimaryAccentThemeEffect(), useWallpaperAmbientColor(), syncActiveSpaceAppearanceCapture(), adjustL(), applyPrimaryAccentFromHex(), fmt(), hexToRgb(), rgbToHslComponents() (+8 more)
...
Cohesion: 0.08
Nodes (23): adjustColorIntensity(), createColorVariations(), DockParticleSystem, hexToRgb(), Particle, PARTICLE_TYPES, getRibbonChromeEffectDefaults(), getRibbonChromeEffectMeta() (+15 more)

### Community 74 - "@dnd-kit/sortable"
Cohesion: 0.19
Nodes (19): elementCanScrollVertically(), getNextSpaceId(), isTypingTarget(), useWheelNavigation(), DEFAULT_CHANNEL_NAVIGATION, WII_LAYOUT_PRESET, CHANNEL_SPACE_KEYS, createDefaultChannelSpaceData() (+11 more)

### Community 78 - "framer-motion"
Cohesion: 0.23
Nodes (11): WorkspaceSwitcherModal(), resolveDisplayWallpaperUrl(), applyWorkspaceSnapshot(), runSceneTransition(), sleep(), waitForWallpaperVisualCommit(), createProfileId(), createSeededWorkspaceState() (+3 more)

### Community 80 - "fuse.js"
Cohesion: 0.22
Nodes (11): ChannelModalBehaviorTab(), CommandPalette(), enterSessionAwayIfIntensive(), useSessionPowerSync(), filterAndGroupCommands(), CASUAL_EXE_NAMES, GAME_PATH_MARKERS, getAutoPerformancePauseHint() (+3 more)

### Community 81 - "gifuct-js"
Cohesion: 0.16
Nodes (16): markAppLibraryBackgroundPrefetchScheduled(), collectPrioritizedWarmMediaUrls(), collectWarmMediaUrlsFromStore(), isHttpLike(), warmedUrls, warmImageUrlsOnIdle(), dedupeMerge(), flush() (+8 more)

### Community 83 - "lucide-react"
Cohesion: 0.14
Nodes (15): ClassicWiiDock(), WiiDock(), DEFAULT_BUTTON_CONFIGS, formatDate(), formatTime(), RibbonMiniature(), useHostWidth(), LazyPrimaryActionsModal (+7 more)

### Community 86 - "prop-types"
Cohesion: 0.30
Nodes (13): hasPatchSettingsApi(), selectPersistedSlices(), useUnifiedSettingsPersistence(), debounceWaiters, flushDebouncedSettingsWrites(), getApi(), loadUnifiedSettingsSnapshot(), safeCall() (+5 more)

### Community 87 - "@radix-ui/react-context-menu"
Cohesion: 0.21
Nodes (9): ResourceUsageIndicator(), getGooeyMintPalette(), GOOEY_HUB_CLASSIC_MINT, GOOEY_HUB_DAYLIGHT_MINT, buildSpotifyGooeyStyleVars(), getSpotifyGooeyShellBackground(), glowFromPrimary(), getResolvedSpotifyWidgetSettings() (+1 more)
...
Cohesion: 0.19
Nodes (21): renderShortcutKeyChips(), RESERVED_SHORTCUT_CHORDS, ShortcutCaptureControl(), CATEGORY_ICONS, CATEGORY_ORDER, toggleHomeBoardArrange(), useHomeBoardArrange(), checkShortcutConflict() (+13 more)
...
Cohesion: 0.21
Nodes (19): AuraHubModalFrame(), FloatingWidgetPresence, clampGooeyIntensity(), createGooeyCloseSpring(), createGooeyModalPanelVariants(), createGooeyOpenSpring(), DEFAULT_GOOEY_PHYSICS, lerp() (+11 more)
...
Cohesion: 0.28
Nodes (10): captureSpaceAppearanceFromState(), mergeLiveStateFromSpaceAppearance(), SPACE_IDS, WALLPAPER_TRANSIENT_KEYS, buildPresetDataFromStore(), buildPresetFromCurrentStore(), cloneSafe(), buildWorkspaceDataFromStore() (+2 more)
...
Cohesion: 0.08
Nodes (13): WeeChannelModal(), CHROME_EFFECT_OPTIONS, WeeChoiceTileGrid(), readCollapseDurationMs(), WeeContentCollapse(), sizeClasses, WeeEmphasisText(), WeeIconHeadingRow() (+5 more)
...
Cohesion: 0.36
Nodes (8): saveUnifiedSoundSettings(), applyPresetData(), normalizeSettingsShape(), isPresetScopeWithHomeChannels(), normalizePresetScope(), normalizePresetSoundsSnapshot(), pickSoundSettings(), SOUND_SETTINGS_KEYS

### Community 135 - "[Unreleased]"
Cohesion: 0.33
Nodes (7): useChannelInteractions(), ChannelSpaceContext, ChannelSpaceProvider(), useChannelSpaceKey(), getRecentLaunchHintTtlMs(), playChannelHover(), stopSfx()
...
Cohesion: 0.29
Nodes (12): WiiChannelStrip(), HomeSlotResizeHandle(), createWeeChannelTileItemVariants(), useHomeSlotResize(), applySlotSpan(), buildOccupancyMap(), canPlaceSpan(), clampSpanToPage() (+4 more)
...
Cohesion: 0.17
Nodes (13): GameHubMinimalDock(), SpotifyGradientOverlay(), SpotifyImmersiveOverlay(), WallpaperOverlay(), PerformanceMonitor(), GLASS_TEST_BTN_STYLE, SystemInfoWidget(), WALLPAPER_OVERLAY_COLORS (+5 more)

### Community 171 - "ChannelModalImageSection.jsx"
Cohesion: 0.19
Nodes (10): CommunityPresets(), ImageModal(), PresetsCommunityCard, SecondaryChannelProfilesCard, WorkspacesSettingsTab, WeeCard(), WInput, WSelect() (+2 more)
...
### Community 178 - "jszip"
Cohesion: 0.48
Nodes (6): DefaultLeftIcon(), DefaultRightIcon(), rgbToRgba(), WiiSideNavigation(), WeeGooeySideNavButton, playChannelClick()

### Community 182 - "iconTinting.js"
Cohesion: 0.52
...
Cohesion: 0.11
Nodes (10): PresetListItem, PresetsSaveCurrentCard, PresetsSavedListCard, Text(), variantMap, buttonVariants, variantSecondarySurface, WButton (+2 more)

### Community 184 - "ChannelReorderVfx.jsx"
Cohesion: 0.52
Nodes (6): applyChannelSlotReorder(), channelIdAtIndex(), collectSlots(), moveParallelArrays(), scatterSlots(), snapshotChannelSlotMaps()

### Community 187 - "cacheDomains.js"
Cohesion: 0.05
Nodes (67): base, m, patch, PrimaryActionsModalComponent(), formatLastRefreshed(), SCOPE_LABELS, SettingsDataCachesCard(), actionStamps (+59 more)

### Community 188 - "applyPrimaryAccentFromHex.js"
Cohesion: 0.50
...
## Knowledge Gaps
- **806 isolated node(s):** `PLAYLISTS`, `SONGS`, `name`, `version`, `main` (+801 more)
