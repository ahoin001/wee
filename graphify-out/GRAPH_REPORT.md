...
## Corpus Check
- 443 files · ~297,836 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2488 nodes · 5545 edges · 182 communities (128 shown, 54 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 73 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `636034b2`
...
Cohesion: 0.08
Nodes (21): UnifiedAppPathCard, UnifiedAppPathSearch(), ChannelPathSmartSuggestions(), MediaLibraryBrowser(), PrimaryActionsModal, IDLE_TYPE_ITEMS, KEN_BURNS_EASING_OPTIONS, KEN_BURNS_MODE_OPTIONS (+13 more)
...
Cohesion: 0.09
Nodes (11): CHROME_EFFECT_OPTIONS, RibbonLivePreview(), withHexAlpha(), SettingsLivePreviewFrame(), DOCK_SUB_TABS, ResourceUsageIndicator(), CLASSIC_DOCK_THEME_GROUPS, CLASSIC_DOCK_DEFAULT_COLORS (+3 more)
...
Cohesion: 0.21
Nodes (6): GooeySettingsRow(), GLASS_TEST_BTN_STYLE, Slider(), WeeIconHeadingRow(), WeePressSurface, sizeClass
