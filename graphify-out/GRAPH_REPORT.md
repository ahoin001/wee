...
## Corpus Check
- 474 files · ~316,584 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2646 nodes · 6078 edges · 201 communities (148 shown, 53 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 85 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `057f8a64`
...
- lucide-react
- PaginatedChannels.jsx
- soundLibraryCache.js
- useSessionPowerSync.js
- collectionFlyAnimations.js
- AuraHubModalFrame.jsx
- mediaHubStremio.js
- AuraHubModalFrame.jsx
- AuthService
- HomeWidgetSettingsPanel.jsx
- STEAM_CDN_CAPSULE
...
Cohesion: 0.06
Nodes (66): PresetsCommunityCard, PresetsSaveCurrentCard, PresetsSavedListCard, PresetsSpotifyMatchSection, PRESET_UPDATE_SCOPE_OPTIONS, WorkspaceSwitcherModal(), captureSpaceAppearanceFromState(), mergeLiveStateFromSpaceAppearance() (+58 more)

### Community 1 - "useConsolidatedAppStore.js"
Cohesion: 0.15
Nodes (25): renderShortcutKeyChips(), RESERVED_SHORTCUT_CHORDS, ShortcutCaptureControl(), CATEGORY_ICONS, CATEGORY_ORDER, toggleHomeBoardArrange(), useHomeBoardArrange(), checkShortcutConflict() (+17 more)
...
Cohesion: 0.18
Nodes (6): UnifiedAppPathCard, ChannelPathSmartSuggestions(), MediaLibraryBrowser(), variantMap, WeeSectionEyebrow(), WeeSegmentedControl()

### Community 4 - "WiiRibbon.jsx"
Cohesion: 0.23
Nodes (14): SpotifyTakeoverController(), listCacheDomains(), buildCommandCatalog(), channelTitleFromSlot(), COMMAND_GROUPS, EXCLUDED_SHORTCUT_IDS, fuzzyScore(), scoreCommand() (+6 more)
...
Cohesion: 0.23
Nodes (18): EMPTY_SYSTEM_SESSIONS, NowPlayingSlot(), EMPTY_NOW_PLAYING, enrichSystemWithPremiumSpotifyControls(), hasTrack(), isSpotifySystemApp(), normalizeNowPlaying(), normalizeNowPlayingSourcePreference() (+10 more)
...
Cohesion: 0.12
Nodes (14): DevReactProfiler(), ColorsSettingsTab, GameHubSettingsTab, GeneralSettingsTab, MonitorSettingsTab, MotionFeedbackSettingsTab, NavigationPillSettingsTab, PresetsSettingsTab (+6 more)
...
Cohesion: 0.11
Nodes (26): SpotifyLiveGradientWallpaper(), formatMessage(), logError(), logWarn(), registerSpotifyGradientSave(), SPOTIFY_SCOPES, applyMediaSearchFilters(), createSession() (+18 more)
...
Cohesion: 0.19
Nodes (12): GameHubMinimalDock(), SpotifyGradientOverlay(), SpotifyImmersiveOverlay(), WallpaperOverlay(), PerformanceMonitor(), SystemInfoWidget(), WALLPAPER_OVERLAY_COLORS, useActivityInterval() (+4 more)
...
Cohesion: 0.11
Nodes (19): DIRECTION_OPTIONS, EFFECT_TYPE_OPTIONS, CHROME_EFFECT_OPTIONS, SettingsToggleFieldCard(), SettingsWeeSection(), SpaceWallpaperAppearanceSection(), WallpaperCyclingSection(), WallpaperLibrarySection() (+11 more)

### Community 29 - "useWeeMotion"
Cohesion: 0.17
Nodes (15): HomePageIndicator(), statusLabel(), UpdateModal(), WeeUpdateProgress(), BoardLivePreview(), LayoutStepper(), createWeeSideNavPeekVariants(), createWeeSideNavShellMotion() (+7 more)

### Community 30 - "mediaLibraryCache.js"
Cohesion: 0.15
Nodes (21): MEDIA_LIBRARY_FILETYPE_OPTIONS, MEDIA_LIBRARY_PAGE_SIZE_OPTIONS, MEDIA_LIBRARY_SORT_OPTIONS, clearMatchCache(), filterMediaLibraryCache(), findGameMedia(), fuzzyMatch(), getAllMatchingMedia() (+13 more)

### Community 31 - "weeMotion.js"
Cohesion: 0.15
Nodes (17): Channel, HomeSlot(), legacyChannelConfigFromSlot(), WIDGET_SLOT_COMPONENTS, getHomeSlotKind(), getHomeSlotSizePreset(), GLANCE_TILE_SIZE_PRESETS, HOME_SLOT_KINDS (+9 more)

### Community 32 - "keyboardShortcuts.js"
Cohesion: 0.18
Nodes (10): UnifiedAppPathSearch(), ChannelsLayoutSettingsTab, IDLE_TYPE_ITEMS, KEN_BURNS_EASING_OPTIONS, KEN_BURNS_MODE_OPTIONS, GOOEY_HOVER_MODES, WeeButton(), WeeHelpLinkButton() (+2 more)
...
Cohesion: 0.22
Nodes (8): AdvancedSettingsTab, QUICK_LINKS, DEFAULT_GLASS, NavigationSettingsTab(), SIDE_NAV_STYLE_OPTIONS, SettingsTabPageHeader(), Text(), WeeModalFieldCard()
...
### Community 59 - "react"
Cohesion: 0.18
Nodes (19): usePrimaryAccentThemeEffect(), useWallpaperAmbientColor(), adjustL(), applyPrimaryAccentFromHex(), fmt(), hexToRgb(), rgbToHslComponents(), applyAmbientRoleTokens() (+11 more)

### Community 72 - "cors"
Cohesion: 0.13
Nodes (15): better-sqlite3, @dnd-kit/utilities, electron-updater, node-fetch, dependencies, better-sqlite3, @dnd-kit/utilities, electron-updater (+7 more)

### Community 73 - "@dnd-kit/core"
Cohesion: 0.20
Nodes (9): useChannelAdaptiveEmptyStyle(), useChannelEffectiveState(), clearMp4PosterCache(), mp4PosterCache, readCachedPoster(), useChannelMediaPreview(), writeCachedPoster(), clearCachedSteamClientLibrary() (+1 more)

### Community 74 - "@dnd-kit/sortable"
Cohesion: 0.18
Nodes (19): EMPTY_FRIENDS_PLAYING, SteamFriendsSlot(), EMPTY_ENRICHED_GAMES, VARIANT_META, SteamCoverTile(), SteamGamesShelf(), refreshSteamEnrichmentNow(), formatSteamPlaytimeShort() (+11 more)
...
Cohesion: 0.25
Nodes (9): WiiDock(), LazyPrimaryActionsModal, WiiRibbon, WiiRibbonComponent(), WiiStyleButton(), getWeeDockBarEntrance(), useWeeMotion(), useRibbonChromeIdleGate() (+1 more)
...
Cohesion: 0.08
Nodes (24): FloatingSpotifyWidget(), SpotifyBrowseView(), SpotifyMiniPlayerBar(), SpotifyPlayerView(), SpotifySettingsView(), SpotifyWidgetChrome(), getGooeyMintPalette(), GOOEY_HUB_CLASSIC_MINT (+16 more)
...
Cohesion: 0.19
Nodes (13): createHomeChannelEntranceBandVariants(), createHubEntranceBandVariants(), createHubEntranceOrchestratorVariants(), createMediaHubGridContainerVariants(), createMediaHubGridItemVariants(), createMediaHubShellBandVariants(), isFirstVisitTier(), MEDIA_HUB_STAGGER (+5 more)

### Community 83 - "lucide-react"
Cohesion: 0.27
Nodes (6): DEFAULT_BUTTON_CONFIGS, formatDate(), formatTime(), RibbonMiniature(), useHostWidth(), hexAlpha()

### Community 84 - "node-fetch"
Cohesion: 0.40
...
Cohesion: 0.20
Nodes (12): ClassicWiiDock(), IsolatedWallpaperBackground, IsolatedWallpaperBackgroundInner(), spaceParallaxBackgroundYPercent(), ClassicDockLivePreview(), EMPTY_RIBBON_BUTTON_CONFIGS, RibbonLivePreview(), SettingsLivePreviewFrame() (+4 more)

### Community 86 - "prop-types"
Cohesion: 0.07
Nodes (59): p-queue, p-queue, base, m, patch, buildChannelPatchFromNormalized(), useAppInitialization(), hasPatchSettingsApi() (+51 more)

### Community 88 - "react-dom"
Cohesion: 0.27
Nodes (7): useNowPlayingColorMatch(), toStoredSession(), useNowPlayingSources(), albumArtPaletteCache, clearAlbumArtPaletteCache(), extractColorsFromAlbumArt(), getAlbumArtPaletteCacheSize()
...
Cohesion: 0.28
Nodes (12): WeatherSlot(), useHomeWeather(), HOME_SLOT_SIZE_PRESETS, matchSizePresetBySpan(), celsiusToFahrenheit(), describeWmoWeatherCode(), fetchOpenMeteoForecast(), formatHomeWeatherTemp() (+4 more)

### Community 95 - "@tanstack/react-virtual"
Cohesion: 0.12
Nodes (16): 10. SECTION RHYTHM RULE, 12. DENSITY & SPACING DISCIPLINE, 14. IMAGE / MEDIA DIRECTION, 16. MULTI-IMAGE CONSISTENCY RULE, 17. CLARITY CHECK, 19. RESPONSE BEHAVIOR, 1. ACTIVE BASELINE CONFIGURATION, 21. FINAL GOAL (+8 more)

### Community 96 - "node-fetch"
Cohesion: 0.50
...
Cohesion: 0.32
Nodes (10): getInitialActivity(), getInitialMainWindowActivity(), useAppActivity(), usePowerPolicy(), useRendererMediaPowerState(), powerProfileFlags(), resolvePowerProfile(), startBackgroundMusicFromSettings() (+2 more)
...
Cohesion: 0.24
Nodes (10): HomeWidgetShell, EMPTY_RECENT_LAUNCHES, LAUNCH_TYPE_FALLBACK_ICONS, RecentlyUsedSlot(), SteamGamesGlanceSlot(), CommandPalette(), EMPTY_PALETTE_RECENTS, useLaunchFeedback() (+2 more)
...
Cohesion: 0.17
Nodes (21): useChannelInteractions(), DefaultLeftIcon(), DefaultRightIcon(), rgbToRgba(), WiiSideNavigation(), useChannelSpaceKey(), useChannelModalHoverSound(), WeeGooeySideNavButton (+13 more)
...
Cohesion: 0.10
Nodes (9): WeeChannelModal(), readCollapseDurationMs(), WeeContentCollapse(), sizeClasses, WeeEmphasisText(), WeeModalRail(), WeeModalRailItem(), WeeModalRailSection() (+1 more)
...
Cohesion: 0.06
Nodes (79): HomeBoardArrangeBar(), HomeWidgetGlassControls(), PageNavigation(), SlideNavigation(), elementCanScrollVertically(), getNextSpaceId(), isTypingTarget(), useWheelNavigation() (+71 more)

### Community 173 - "usePerformanceOptimization.js"
Cohesion: 0.20
Nodes (4): VirtualizedChannelList, performanceChecklist, performanceUtils, usePerformanceMonitor()
...
Cohesion: 0.27
Nodes (9): ChannelDragOverlayFrame(), ChannelDropTargetMotion(), channelDragId(), ChannelSlotDnd(), channelSlotId(), parseChannelDnDId(), GooeyFloatingPanel(), WEE_SPRINGS (+1 more)

### Community 177 - "AuraLibrarySection.jsx"
Cohesion: 0.12
Nodes (9): SettingsActionMenu, SOUND_CATEGORY_DESCRIPTIONS, SOUND_CATEGORY_ICONS, SoundsSettingsTab, ResourceUsageIndicator(), GooeySettingsRow(), WeeDescriptionToggleRow(), WeeIconHeadingRow() (+1 more)
...
### Community 179 - "PaginatedChannels.jsx"
Cohesion: 0.20
Nodes (8): PaginatedChannelsInner, ChannelSpaceContext, ChannelSpaceProvider(), CHANNEL_IDLE_MS, getChannelIdleDurationMs(), useHomeIdleExperience(), getSlotAt(), useIdleChannelAnimations()

### Community 180 - "soundLibraryCache.js"
Cohesion: 0.29
...
### Community 181 - "useSessionPowerSync.js"
Cohesion: 0.26
...
### Community 182 - "collectionFlyAnimations.js"
Cohesion: 0.39
...
Cohesion: 0.08
Nodes (18): CommunityPresets(), PresetListItem, ImageModal(), PrimaryActionsModal, SecondaryChannelProfilesCard, SteamIntegrationSettings, WorkspacesSettingsTab, buttonVariants (+10 more)

### Community 185 - "AuraHubModalFrame.jsx"
Cohesion: 0.31
...
### Community 187 - "HomeWidgetSettingsPanel.jsx"
Cohesion: 0.24
Nodes (9): homeSlotKindHasWidgetSettings(), HomeWidgetSettingsPanel(), STEAM_KIND_IDS, SteamWidgetSettings(), WeatherWidgetSettings(), DEFAULT_HOME_STEAM_WIDGET, HOME_STEAM_SCROLL_AXES, HOME_STEAM_TILE_SIZES (+1 more)

### Community 189 - "ChannelReorderVfx.jsx"
Cohesion: 0.33
...
Cohesion: 0.39
Nodes (7): LaunchErrorToast(), LaunchFeedbackContext, LaunchFeedbackProvider(), setLaunchCinematic(), buildLaunchErrorReport(), getLaunchErrorPresentation(), openSettingsToTab()

### Community 194 - "settingsRegistry.js"
Cohesion: 0.43
...
## Knowledge Gaps
- **823 isolated node(s):** `PLAYLISTS`, `SONGS`, `name`, `version`, `main` (+818 more)
...
- **Why does `dependencies` connect `cors` to `UnifiedDockSettingsTab.jsx`, `WiiDesktop Launcher`, `useActivityInterval`, `WeeFadeScroll.jsx`, `ChannelsLayoutSettingsTab.jsx`, `cacheDomains.js`, `package.json`, `fuse.js`, `lucide-react`, `prop-types`, `mediaHubStremio.js`, `cors`, `cors`, `@tanstack/react-virtual`, `gifuct-js`, `@dnd-kit/sortable`, `fast-deep-equal`, `express`, `prop-types`, `@radix-ui/react-context-menu`, `react-freezeframe-vite`, `sharp`, `systeminformation`, `node-fetch`, `windows-shortcuts`, `zustand`, `react-dom`, `nowPlayingShape.js`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `react` connect `node-fetch` to `cors`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `lazyNamedExport()` connect `node-fetch` to `App.jsx`?**
