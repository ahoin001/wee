...
## Corpus Check
- 473 files · ~316,254 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2634 nodes · 6066 edges · 189 communities (137 shown, 52 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 85 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e8e80f6a`
...
Cohesion: 0.06
Nodes (62): PresetsCommunityCard, PresetsSaveCurrentCard, PresetsSavedListCard, PresetsSpotifyMatchSection, PRESET_UPDATE_SCOPE_OPTIONS, PresetsSettingsTab, WorkspaceSwitcherModal(), applyPresetData() (+54 more)

### Community 1 - "useConsolidatedAppStore.js"
Cohesion: 0.23
Nodes (18): renderShortcutKeyChips(), RESERVED_SHORTCUT_CHORDS, ShortcutCaptureControl(), CATEGORY_ICONS, CATEGORY_ORDER, ShortcutsSettingsTab, checkShortcutConflict(), createDefaultKeyboardShortcuts() (+10 more)

### Community 2 - "PaginatedChannels.jsx"
Cohesion: 0.05
Nodes (70): AuraCollectionsSection(), nextFrame(), preloadGameArt(), shouldIgnoreCollectionCloseTarget(), waitMs(), AuraGameCard, AuraHubModalFrame(), COLLECTION_FLY_PHASE_MS (+62 more)

### Community 3 - "FloatingSpotifyWidget.jsx"
Cohesion: 0.11
Nodes (11): UnifiedAppPathCard, UnifiedAppPathSearch(), PrimaryActionsModal, SettingsActionMenu, WEE_VARIANTS, VARIANT_MAP, WeeButton(), WeeDescriptionToggleRow() (+3 more)

### Community 4 - "WiiRibbon.jsx"
Cohesion: 0.20
Nodes (13): LaunchErrorToast(), LAUNCH_TYPE_FALLBACK_ICONS, RecentlyUsedSlot(), CommandPalette(), LaunchFeedbackContext, LaunchFeedbackProvider(), setLaunchCinematic(), useLaunchFeedback() (+5 more)
...
Cohesion: 0.15
Nodes (31): PageNavigation(), SlideNavigation(), applyLayoutChangeToSpaceData(), CHANNEL_LAYOUT_LIMITS, channelIdAtIndex(), clampInt(), clampPageIndex(), DEFAULT_CHANNEL_NAVIGATION (+23 more)
...
Cohesion: 0.05
Nodes (68): NowPlayingSlot(), SpotifyTakeoverController(), formatLastRefreshed(), SCOPE_LABELS, SettingsDataCachesCard(), useHomeIdleExperience(), useNowPlayingColorMatch(), toStoredSession() (+60 more)
...
Cohesion: 0.12
Nodes (24): NavigationSettingsTab(), formatMessage(), logError(), logWarn(), SPOTIFY_SCOPES, applyMediaSearchFilters(), createSession(), downloadPreset() (+16 more)
...
Cohesion: 0.17
Nodes (11): SpotifyGradientOverlay(), SpotifyImmersiveOverlay(), SpotifyLiveGradientWallpaper(), WallpaperOverlay(), WALLPAPER_OVERLAY_COLORS, useAnimationActivity(), useMusicReactiveLevels(), ZERO_LEVELS (+3 more)

### Community 20 - "managers.js"
Cohesion: 0.21
Nodes (13): AuraLibrarySection(), GameHubSpace(), smoothstep01(), useMinWidthDockMorph(), orderHubCollectionItems(), sortHubGamesByName(), useHeroMediaCrossfade(), createHubEntranceFadeVariants() (+5 more)
...
Cohesion: 0.25
Nodes (11): IsolatedWallpaperBackground, IsolatedWallpaperBackgroundInner(), spaceParallaxBackgroundYPercent(), useSpaceWallpaperCrossfade(), elementCanScrollVertically(), getNextSpaceId(), isTypingTarget(), useWheelNavigation() (+3 more)
...
Cohesion: 0.27
Nodes (10): SpaceWallpaperAppearanceSection(), WallpaperCyclingSection(), WallpaperLibrarySection(), EASING_OPTIONS, SLIDE_DIRECTION_MODE_OPTIONS, SLIDE_DIRECTION_OPTIONS, SPACE_WALLPAPER_OPTIONS, WALLPAPER_ANIMATIONS (+2 more)

### Community 29 - "useWeeMotion"
Cohesion: 0.12
Nodes (24): HomePageIndicator(), statusLabel(), UpdateModal(), BoardLivePreview(), LayoutStepper(), createWeeSideNavPeekVariants(), createWeeSideNavShellMotion(), createWeeTransition() (+16 more)
...
Cohesion: 0.11
Nodes (24): HomeBoardArrangeBar(), HomeSlot(), legacyChannelConfigFromSlot(), WIDGET_SLOT_COMPONENTS, getHomeSlotKind(), getHomeSlotSizePreset(), GLANCE_TILE_SIZE_PRESETS, HOME_SLOT_KINDS (+16 more)

### Community 32 - "keyboardShortcuts.js"
Cohesion: 0.15
Nodes (9): SecondaryChannelProfilesCard, SteamIntegrationSettings, WorkspacesSettingsTab, GooeySettingsRow(), buttonVariants, variantSecondarySurface, WeeCard(), WInput (+1 more)

### Community 33 - "Text.jsx"
Cohesion: 0.33
Nodes (10): hydrateSoundLibrary(), listeners, notify(), sanitizeLibrary(), setSoundLibraryCache(), subscribeSoundLibrary(), startBackgroundMusicFromSettings(), stopBackgroundMusic() (+2 more)
...
Cohesion: 0.21
Nodes (8): WeeUpdateProgress(), AdvancedSettingsTab, QUICK_LINKS, DEFAULT_GLASS, SIDE_NAV_STYLE_OPTIONS, SettingsTabPageHeader(), SettingsWeeSection(), WeeModalFieldCard()
...
### Community 59 - "react"
Cohesion: 0.17
Nodes (19): useCursorEffect(), useFullscreenEffect(), useGlobalKeyHandlers(), usePrimaryAccentThemeEffect(), useThemeEffect(), handleShellEscapeKey(), adjustL(), applyPrimaryAccentFromHex() (+11 more)

### Community 72 - "cors"
Cohesion: 0.13
Nodes (15): better-sqlite3, cors, electron-updater, node-fetch, dependencies, better-sqlite3, cors, electron-updater (+7 more)
...
Cohesion: 0.16
Nodes (25): HomeWidgetShell, matchHomeSlotSizePreset(), SteamFriendsSlot(), SteamGamesGlanceSlot(), VARIANT_META, SteamCoverTile(), SteamGamesShelf(), refreshSteamEnrichmentNow() (+17 more)

### Community 76 - "electron-updater"
Cohesion: 0.24
Nodes (7): ClassicWiiDock(), WiiDock(), DockParticleSystem, CLASSIC_DOCK_THEME_GROUPS, CLASSIC_DOCK_DEFAULT_COLORS, getWeeDockBarEntrance(), toDockParticleProps()
...
Cohesion: 0.06
Nodes (50): AdminPanel(), EMPTY_CUSTOM, AdminPanelWidget(), ActionCommand(), QuickAccessItem(), AdminQuickAccessSlot(), layoutCellsForPreset(), splitActionsByCapacity() (+42 more)

### Community 80 - "fuse.js"
Cohesion: 0.44
Nodes (6): toggleHomeBoardArrange(), useHomeBoardArrange(), handleGlobalShortcut(), closeTopOverlayOnEscape(), isBlockingOverlayOpen(), useKeyboardShortcuts()
...
Cohesion: 0.24
Nodes (12): createGameHubMorphLibraryFollowVariants(), createHomeChannelEntranceBandVariants(), createHubEntranceBandVariants(), createHubEntranceOrchestratorVariants(), createMediaHubGridContainerVariants(), createMediaHubGridItemVariants(), createMediaHubShellBandVariants(), isFirstVisitTier() (+4 more)
...
Cohesion: 0.70
Nodes (4): saveUnifiedSoundSettings(), refreshSoundLibrary(), updateBackgroundMusicLooping(), useSoundSettingsActions()

### Community 85 - "p-queue"
Cohesion: 0.15
Nodes (17): ClassicDockLivePreview(), RibbonLivePreview(), SettingsLivePreviewFrame(), useWallpaperSettingsController(), useWallpaperAmbientColor(), captureSpaceAppearanceFromState(), mergeLiveStateFromSpaceAppearance(), SPACE_IDS (+9 more)

### Community 86 - "prop-types"
Cohesion: 0.07
Nodes (57): p-queue, p-queue, base, m, patch, buildChannelPatchFromNormalized(), useAppInitialization(), hasPatchSettingsApi() (+49 more)
...
Cohesion: 0.20
Nodes (17): homeSlotKindHasWidgetSettings(), HomeWidgetSettingsPanel(), STEAM_KIND_IDS, SteamWidgetSettings(), WeatherWidgetSettings(), WeatherSlot(), useHomeWeather(), matchSizePresetBySpan() (+9 more)
...
Cohesion: 0.11
Nodes (11): WeeChannelModal(), WeeChoiceTileGrid(), readCollapseDurationMs(), WeeContentCollapse(), sizeClasses, WeeEmphasisText(), WeeIconHeadingRow(), WeeModalRail() (+3 more)
...
Cohesion: 0.15
Nodes (29): applyChannelSlotReorder(), channelIdAtIndex(), collectSlots(), moveParallelArrays(), scatterSlots(), snapshotChannelSlotMaps(), buildChannelPayload(), channelToConfiguredEntry() (+21 more)
...
Cohesion: 0.09
Nodes (18): ChannelsLayoutSettingsTab, IDLE_TYPE_ITEMS, KEN_BURNS_EASING_OPTIONS, KEN_BURNS_MODE_OPTIONS, DIRECTION_OPTIONS, EFFECT_TYPE_OPTIONS, CHROME_EFFECT_OPTIONS, MotionFeedbackSettingsTab (+10 more)

### Community 178 - "lucide-react"
Cohesion: 0.19
Nodes (15): LazyPrimaryActionsModal, WiiRibbon, WiiRibbonComponent(), WiiStyleButton(), PrimaryActionsModalComponent(), useRibbonChromeIdleGate(), analyzeIconTransparency(), clampSampleSize() (+7 more)

### Community 183 - "AuraHubModalFrame.jsx"
Cohesion: 0.10
Nodes (10): CommunityPresets(), PresetListItem, ImageModal(), GLASS_TEST_BTN_STYLE, Text(), variantMap, WButton, WeeModalShell() (+2 more)

## Knowledge Gaps
- **813 isolated node(s):** `PLAYLISTS`, `SONGS`, `name`, `version`, `main` (+808 more)
...
- **Why does `dependencies` connect `cors` to `UnifiedDockSettingsTab.jsx`, `WiiDesktop Launcher`, `useActivityInterval`, `ChannelsLayoutSettingsTab.jsx`, `cacheDomains.js`, `package.json`, `uuid`, `mediaHubStremio.js`, `cors`, `better-sqlite3`, `cors`, `spotify-web-api-js`, `@tanstack/react-virtual`, `gifuct-js`, `lucide-react`, `prop-types`, `fast-deep-equal`, `@dnd-kit/utilities`, `express`, `prop-types`, `@radix-ui/react-context-menu`, `react-freezeframe-vite`, `sharp`, `systeminformation`, `windows-shortcuts`, `zustand`, `WeePressSurface.jsx`, `nowPlayingShape.js`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `react` connect `WeePressSurface.jsx` to `cors`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `lazyNamedExport()` connect `WeePressSurface.jsx` to `App.jsx`?**
