...
## Corpus Check
- 461 files · ~307,140 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2557 nodes · 5792 edges · 191 communities (133 shown, 58 thin omitted)
...
## Communities (191 total, 58 thin omitted)

### Community 0 - "PresetsSettingsTab.jsx"
Cohesion: 0.06
Nodes (63): PresetsCommunityCard, PresetsSaveCurrentCard, PresetsSavedListCard, PresetsSpotifyMatchSection, PRESET_UPDATE_SCOPE_OPTIONS, WorkspaceSwitcherModal(), captureSpaceAppearanceFromState(), mergeLiveStateFromSpaceAppearance() (+55 more)
...
Cohesion: 0.09
Nodes (20): UnifiedAppPathCard, UnifiedAppPathSearch(), WeeChannelModal(), MediaLibraryBrowser(), PrimaryActionsModal, WeeButton(), sizeClasses, WeeEmphasisText() (+12 more)

### Community 4 - "WiiRibbon.jsx"
Cohesion: 0.25
Nodes (10): LazyPrimaryActionsModal, WiiRibbon, WiiRibbonComponent(), PrimaryActionsModalComponent(), useRibbonChromeIdleGate(), hexAlpha(), extractColorsFromAlbumArt(), getTintedIconUrl() (+2 more)
...
Cohesion: 0.16
Nodes (18): AuraLibrarySection(), GameHubSpace(), smoothstep01(), useMinWidthDockMorph(), orderHubCollectionItems(), sortHubGamesByName(), useHeroMediaCrossfade(), HUB_MORPH (+10 more)
...
Cohesion: 0.12
Nodes (13): DevReactProfiler(), ColorsSettingsTab, GeneralSettingsTab, MonitorSettingsTab, MotionFeedbackSettingsTab, NavigationPillSettingsTab, PresetsSettingsTab, SETTINGS_TAB_COMPONENTS (+5 more)

### Community 11 - "AdminPanel.jsx"
Cohesion: 0.20
Nodes (12): AuraCollectionsSection(), nextFrame(), preloadGameArt(), shouldIgnoreCollectionCloseTarget(), waitMs(), AuraGameCard, COLLECTION_FLY_PHASE_MS, CollectionShelfContextMenu() (+4 more)
...
Cohesion: 0.09
Nodes (20): FloatingSpotifyWidget(), SpotifyBrowseView(), SpotifyMiniPlayerBar(), SpotifyPlayerView(), SpotifySettingsView(), SpotifyWidgetChrome(), getGooeyMintPalette(), GOOEY_HUB_CLASSIC_MINT (+12 more)

### Community 16 - "supabase.js"
Cohesion: 0.11
Nodes (25): NavigationSettingsTab(), formatMessage(), logError(), logWarn(), SPOTIFY_SCOPES, applyMediaSearchFilters(), clearSupabaseReadCache(), createSession() (+17 more)

### Community 17 - "index.js"
Cohesion: 0.31
Nodes (6): ClassicWiiDock(), WiiDock(), CLASSIC_DOCK_THEME_GROUPS, CLASSIC_DOCK_DEFAULT_COLORS, getWeeDockBarEntrance(), toDockParticleProps()
...
Cohesion: 0.12
Nodes (12): ChannelModalBehaviorTab(), BoardLivePreview(), ChannelsLayoutSettingsTab, IDLE_TYPE_ITEMS, KEN_BURNS_EASING_OPTIONS, KEN_BURNS_MODE_OPTIONS, LayoutStepper(), GooeySettingsRow() (+4 more)
...
Cohesion: 0.05
Nodes (74): ClockSlot(), formatClockDate(), formatClockTime(), HomeBoardArrangeBar(), HomeSlot(), legacyChannelConfigFromSlot(), WIDGET_SLOT_COMPONENTS, HomeWidgetShell (+66 more)
...
Cohesion: 0.10
Nodes (43): WiiChannelStrip(), HomeSlotResizeHandle(), PageNavigation(), SlideNavigation(), createWeeChannelTileItemVariants(), useHomeSlotResize(), applyLayoutChangeToSpaceData(), CHANNEL_LAYOUT_LIMITS (+35 more)

### Community 29 - "useWeeMotion"
Cohesion: 0.10
Nodes (30): HomePageIndicator(), statusLabel(), UpdateModal(), WeeUpdateProgress(), SettingsActionMenu, PLAYFUL_AMPLITUDE, PLAYFUL_SPRINGS, PLAYFUL_VARIANTS (+22 more)
...
Cohesion: 0.19
Nodes (15): ChannelDragOverlayFrame(), ChannelDropTargetMotion(), ChannelReorderVfxPortal(), measureChannelSlotCenter(), channelDragId(), ChannelSlotDnd(), channelSlotId(), parseChannelDnDId() (+7 more)
...
Cohesion: 0.20
Nodes (13): IsolatedWallpaperBackground, IsolatedWallpaperBackgroundInner(), spaceParallaxBackgroundYPercent(), SPACE_SHELL_ENTRANCE_TIERS, useSpaceWallpaperCrossfade(), elementCanScrollVertically(), getNextSpaceId(), isTypingTarget() (+5 more)
...
Cohesion: 0.14
Nodes (15): AdvancedSettingsTab, QUICK_LINKS, GameHubSettingsTab, DEFAULT_GLASS, SIDE_NAV_STYLE_OPTIONS, SettingsTabPageHeader(), SettingsToggleFieldCard(), SettingsWeeSection() (+7 more)
...
Cohesion: 0.26
Nodes (6): SpotifyGradientOverlay(), SpotifyLiveGradientWallpaper(), WallpaperOverlay(), WALLPAPER_OVERLAY_COLORS, useAnimationActivity(), registerSpotifyGradientSave()

### Community 78 - "framer-motion"
Cohesion: 0.27
Nodes (7): ClassicDockLivePreview(), RibbonLivePreview(), SettingsLivePreviewFrame(), wallpaperEntryUrlKey(), runSceneTransition(), sleep(), waitForWallpaperVisualCommit()
...
Cohesion: 0.25
Nodes (6): DEFAULT_BUTTON_CONFIGS, formatDate(), formatTime(), RibbonMiniature(), useHostWidth(), WiiStyleButton()

### Community 86 - "prop-types"
Cohesion: 0.11
Nodes (40): base, m, patch, hasPatchSettingsApi(), selectPersistedSlices(), useUnifiedSettingsPersistence(), debounceWaiters, electronApi (+32 more)
...
Cohesion: 0.08
Nodes (42): LaunchErrorToast(), renderShortcutKeyChips(), RESERVED_SHORTCUT_CHORDS, ShortcutCaptureControl(), CATEGORY_ICONS, CATEGORY_ORDER, computeSpaceRailContentHeight(), getNextSpace() (+34 more)
...
Cohesion: 0.35
Nodes (10): hubExpansionVisibleHeightRatio(), maybeScrollHubExpansionIntoView(), readHubDockInsetPx(), readHubScrollTopReservePx(), scrollHubRegionIntoFocus(), MediaHubLocalShelfSection(), nextFrame(), preloadGameArt() (+2 more)
...
Cohesion: 0.18
Nodes (11): FloatingWidgetPresence, ResourceUsageIndicator(), GLASS_TEST_BTN_STYLE, SystemInfoWidget(), useDialogExitPresence(), variantNameFromDefinition(), defaultUncontrolledSize(), useFloatingWidgetFrame() (+3 more)

### Community 128 - "SystemInfoWidget.jsx"
Cohesion: 0.11
Nodes (9): DIRECTION_OPTIONS, EFFECT_TYPE_OPTIONS, CHROME_EFFECT_OPTIONS, DOCK_SUB_TABS, UnifiedDockSettingsTab, WeeChoiceTileGrid(), WSelect(), findDockThemePath() (+1 more)
...
Cohesion: 0.20
Nodes (10): GameHubMinimalDock(), SpotifyImmersiveOverlay(), PerformanceMonitor(), useActivityInterval(), toStoredSession(), useNowPlayingSources(), useSharedSpotifyPlaybackSampler(), useSpotifyPlaybackSample() (+2 more)
...
Cohesion: 0.09
Nodes (15): CommunityPresets(), PresetListItem, AuraHubModalFrame(), ImageModal(), SecondaryChannelProfilesCard, WorkspacesSettingsTab, buttonVariants, variantSecondarySurface (+7 more)

### Community 187 - "cacheDomains.js"
Cohesion: 0.05
Nodes (57): SpotifyTakeoverController(), formatLastRefreshed(), SCOPE_LABELS, SettingsDataCachesCard(), SettingsModal(), actionStamps, clearAllCacheDomains(), clearCacheDomain() (+49 more)
