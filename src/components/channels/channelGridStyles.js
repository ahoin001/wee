import { CHANNEL_PAGE_FLIP_MS, createWiiBoardTrackStyle } from '../../utils/channelLayoutSystem';
...
export const createWiiStripGridStyle = ({ columns, rows, totalPages, currentPage, isAnimating }) => {
  ...
  const tracks = createWiiBoardTrackStyle({ columns, rows, totalPages: safeTotalPages });
