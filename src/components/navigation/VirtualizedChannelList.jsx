...
const VirtualizedChannelList = React.memo(({
  ...
  adaptiveEmptyChannels: _adaptiveEmptyChannels,
  kenBurnsEnabled: _kenBurnsEnabled,
  kenBurnsMode: _kenBurnsMode,
  idleAnimationEnabled: _idleAnimationEnabled,
  idleAnimationTypes: _idleAnimationTypes,
  idleAnimationInterval: _idleAnimationInterval,
  onMediaChange,
  onAppPathChange,
  onChannelSave,
  onChannelHover,
