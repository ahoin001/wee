...
const WiiDock = ({ 
  ...
  const renderBuiltInIcon = (iconType) => {
    switch (iconType) {
      case 'palette':
        return (
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke={colors.dockAccentColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  const dockStyleVars = {
    ...
    '--dock-glass-opacity-soft': glassOpacity * 0.8,
    '--dock-glass-blur': `${glassBlur}px`,
    '--dock-glass-border-opacity': glassBorderOpacity,
    '--dock-glass-shine-opacity': glassShineOpacity,
    '--dock-glass-svg-opacity': glassEnabled ? 0.7 : 1,
    '--dock-pod-svg-opacity': glassEnabled ? 0.8 : 1,
    '--dock-button-border': colors.buttonBorderColor,
    '--dock-button-gradient-start': colors.buttonGradientStart,
    '--dock-button-gradient-end': colors.buttonGradientEnd,
    '--dock-button-icon-left': colors.buttonIconColor,
    '--dock-button-icon-right': colors.rightButtonIconColor,
    '--dock-button-highlight': colors.buttonHighlightColor
  };
    ...
    >
      ...
      >
        ...
        <div className="wii-left-pod">
          <svg viewBox="0 0 610 450" fill="none" xmlns="http://www.w3.org/2000/svg" className="wii-pod-svg">
          ...
          >
                      ...
                      <div className="wii-button-icon">
                             ...
                             <span 
                               className={`wii-button-text text-wii-gray-dark font-bold ${buttonConfigs[0].textFont === 'digital' ? 'wii-button-text-digital' : 'wii-button-text-orbitron'}`}
                             >
                               {buttonConfigs[0].text || 'Wii'}
                             </span>
                           ) : buttonConfigs[0] && buttonConfigs[0].icon === 'palette' ? (
                             <svg className="palette-icon wii-icon-centered" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke={colors.buttonIconColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                               <circle cx="13.5" cy="6.5" r="2.5"/>
                               <circle cx="17.5" cy="10.5" r="2.5"/>
                               <circle cx="8.5" cy="7.5" r="2.5"/>
                               <circle cx="6.5" cy="12.5" r="2.5"/>
                             ...
                             <svg className="star-icon wii-icon-centered" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke={colors.buttonIconColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                               <polygon points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26"/>
                             </svg>
                           ) : buttonConfigs[0] && buttonConfigs[0].icon === 'heart' ? (
                             <svg className="heart-icon wii-icon-centered" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke={colors.buttonIconColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                               <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
                             </svg>
                             ...
                             <img 
                               ...
                               alt="icon" 
                                className={`wii-button-custom-icon ${buttonConfigs[0].useWiiGrayFilter ? 'wii-button-custom-icon-gray' : ''}`}
                             />
                          ) : (
        ...
        <div className="wii-right-pod">
          <svg viewBox="0 0 538.5 449" fill="none" xmlns="http://www.w3.org/2000/svg" className="wii-pod-svg">
                      ...
                      <div className="wii-button-content">
                          <div className="wii-button-icon">
                              {buttonConfigs[1] && buttonConfigs[1].type === 'text' ? (
                                <span 
                                  className={`wii-button-text wii-button-text-right text-wii-gray-dark font-bold ${buttonConfigs[1].textFont === 'digital' ? 'wii-button-text-digital' : 'wii-button-text-orbitron'}`}
                                >
                                  {buttonConfigs[1].text || 'Mail'}
                                </span>
                              ) : buttonConfigs[1] && buttonConfigs[1].icon === 'palette' ? (
                                <svg className="palette-icon wii-icon-centered" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke={colors.rightButtonIconColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                  <circle cx="13.5" cy="6.5" r="2.5"/>
                                  <circle cx="17.5" cy="10.5" r="2.5"/>
                                  <circle cx="8.5" cy="7.5" r="2.5"/>
                                  <circle cx="6.5" cy="12.5" r="2.5"/>
                                ...
                                <svg className="star-icon wii-icon-centered" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke={colors.rightButtonIconColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                  <polygon points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26"/>
                                </svg>
                              ) : buttonConfigs[1] && buttonConfigs[1].icon === 'heart' ? (
                                <svg className="heart-icon wii-icon-centered" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke={colors.rightButtonIconColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                  <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
                                </svg>
                                ...
                                <img 
                                  ...
                                  alt="icon" 
                                  className={`wii-button-custom-icon ${buttonConfigs[1].useWiiGrayFilter ? 'wii-button-custom-icon-gray' : ''}`}
                                />
                              ) : (
