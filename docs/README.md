...
| Doc | Purpose |
|-----|---------|
| [supabase-setup.md](supabase-setup.md) | Supabase URL, keys, storage, and community presets |
| [spotify-setup.md](spotify-setup.md) | Spotify API integration for the floating widget |
